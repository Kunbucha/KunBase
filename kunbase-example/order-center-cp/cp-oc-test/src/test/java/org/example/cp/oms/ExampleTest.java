...
public class ExampleTest {
    ...
    public void dynamicLoadPlugins() throws Exception {
        ...
        DDD.getContainer().loadPartnerPlugin(new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-bp-isv-0.0.1.jar?raw=true"), "org.example.bp");
        DDD.getContainer().loadPartnerPlugin(new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-bp-ka-0.0.1.jar?raw=true"), "org.example.bp");

        DDD.getContainer().loadPatternPlugin(new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-pattern-0.0.1.jar?raw=true"), "org.example.cp");
