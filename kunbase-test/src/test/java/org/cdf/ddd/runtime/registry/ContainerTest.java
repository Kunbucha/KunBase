...
public class ContainerTest {
    ...
    public void jarTempLocalFile() throws Exception {
        URL jarUrl = new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-bp-isv-0.0.1.jar");
        ...
        jarUrl = new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-bp-isv-0.0.1.jar?raw=true");
    ...
    public void loadPartnerPluginSmokeTest() throws MalformedURLException {
        try {
            DDD.getContainer().loadPartnerPlugin(new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-bp-isv-0.0.1.jar?raw=true"), null);
            fail();
    ...
    public void loadPatternPluginSmokeTest() throws MalformedURLException {
        try {
            DDD.getContainer().loadPatternPlugin(new URL("https://github.com/kunbucha/kunbase-framework/blob/master/doc/assets/jar/order-center-pattern-0.0.1.jar?raw=true"), null);
            fail();
        } catch (NoClassDefFoundError expected) {
        } catch (Exception unexpected) {
            fail();
