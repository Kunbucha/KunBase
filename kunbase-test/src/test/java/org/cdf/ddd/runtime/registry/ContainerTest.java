...
public class ContainerTest {
    ...
    public void jarTempLocalFile() throws Exception {
        URL jarUrl = new URL("https://github.com/kunbucha/kunbase-framework/raw/loader/doc/assets/jar/order-center-bp-isv-0.0.1.jar");
        assertEquals("/kunbucha/kunbase-framework/raw/loader/doc/assets/jar/order-center-bp-isv-0.0.1.jar", jarUrl.getFile());
