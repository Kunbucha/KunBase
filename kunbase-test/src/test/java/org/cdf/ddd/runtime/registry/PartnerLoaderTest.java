...
public class PartnerLoaderTest {
    ...
    public void start() throws Exception {
        ...
        fooJar.load("../kunbase-example/order-center-bp-isv/target/order-center-bp-isv-0.0.1.jar", "org.example.bp");
        context.stop();
    }
    ...
    public void jarName() {
        ...
        assertEquals("order-center-bp-isv-0.0.1.jar", loader.jarName("../kunbase-example/order-center-bp-isv/target/order-center-bp-isv-0.0.1.jar"));
